<div id="Edit_Password" tabindex="-50" role="dialog" class="modal fade  colored-header colored-header-dark">
    <div class="modal-dialog ">
        <div class="modal-content">
            <form action="../Process_teacher/P_Edit_Password.php" method="GET" style="border-radius: 0px;"
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-default btn-lg" data-dismiss="modal" aria-hidden="true"
