<div id="reset_Password" tabindex="-50" role="dialog" class="modal fade  colored-header colored-header-dark">
    <div class="modal-dialog ">
        <div class="modal-content">
            <form action="../Process_Faculty/P_Reset_Password.php" method="GET" style="border-radius: 0px;"
