<div id="mod-EditProfileTeacher" tabindex="-1" role="dialog" style=""
    class="modal fade colored-header colored-header-danger">
    <div class="modal-dialog ">
        <form action="../Process_teacher/P_EditProfile.php" method="GET" style="border-radius: 0px;"
