...
$html = ' 
<h1 align="center">รายงานสรุปการสอบโครงงาน 1 คณะวิศวกรรมศาสตร์ ภาค '.$Term.'/'.$year.'</h1>
<h3 align="center">(สาขาวิชา'.$ba_name .')</h3>
    <table border="1">
     <thead>
             <tr>
                <th width="50" align="center">ลับดับที่</th>
                <th width="170" align="center">ชื่อโครงงาน</th>
    ...
    foreach($result as $val){
        ...
        $html .= '
                <tr cellpadding="10"> 
                    ...
                    <td width="170" white-space="normal" > '.$val['Pro_name'].' </td>
