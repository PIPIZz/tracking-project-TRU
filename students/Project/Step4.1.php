<form action="../Process_Project/P_Update_upload.php" method="POST" enctype="multipart/form-data">
    ...
    <?php
            ...
            $p=$res['Pro_id'];
            // echo $p;
            $sql1 = "SELECT * FROM file1 as f INNER JOIN file_detail as d ON d.F_id = f.F_id Where Pro_id = '$p' AND f.Type = 3 ";
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-center">
           ดาวน์โหลดไฟล์แก้ไข<a href="<?="../fileupload/".$res1['File'];?>" target="_blank" class="btn btn-primary" >Download</a></button>
                <br>
            </p>

            <div class="mb-3">
                <label class="form-label h4">อัพโหลดไฟล์บทที่ 3  </label>
    ...
    <input type="hidden" id="type" name="type" value=3 class="form-control ">
</form>
