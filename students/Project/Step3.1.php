<form action="../Process_Project/P_Update_upload.php" method="POST" enctype="multipart/form-data">
    ...
    <?php
            ...
            $p=$res['Pro_id'];
            // echo $p;
            $sql1 = "SELECT * FROM file1 as f INNER JOIN file_detail as d ON d.F_id = f.F_id Where Pro_id = '$p' AND f.Type = 2 ";
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-center">
            ดาวน์โหลดไฟล์แก้ไข
                <a class="btn btn-primary"  href="<?="../fileupload/".$res1['File'];?>" target="_blank">Download</a>
                <br>
            </p>
