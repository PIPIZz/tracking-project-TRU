<form action="../Process_Project/P_Upload2.php" method="POST" class="form-horizontal group-border-dashed"
    enctype="multipart/form-data">
    <div class="card" style="width: ">
        <div class="card-body">

            <label class="col-sm-3 form-label">
                <h4> เพิ่มไฟล์ บทที่ 2</h4>
            </label>
            <br>
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">กรุณาเลือก File</label>
                <input class="form-control" type="file" id="fileupload2" name="fileupload2">
            </div>
        </div>
